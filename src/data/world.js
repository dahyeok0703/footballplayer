...
export const LEAGUES = [
  ...
  { id: 'eng3', name: 'EFL League One', country: '잉글랜드', code: 'ENG', tier: 3, conf: 'UEFA', strength: 60, size: 24, promotesTo: 'eng2', relegatesTo: 'eng4', continentalSpots: 0, cupId: 'fa_cup' },
  { id: 'eng4', name: 'EFL League Two', country: '잉글랜드', code: 'ENG', tier: 4, conf: 'UEFA', strength: 50, size: 24, promotesTo: 'eng3', relegatesTo: null, continentalSpots: 0, cupId: 'fa_cup' },
  ...
  { id: 'esp2', name: 'La Liga 2', country: '스페인', code: 'ESP', tier: 2, conf: 'UEFA', strength: 72, size: 22, promotesTo: 'esp1', relegatesTo: 'esp3', continentalSpots: 0, cupId: 'copa_rey' },
  { id: 'esp3', name: 'Primera Federación', country: '스페인', code: 'ESP', tier: 3, conf: 'UEFA', strength: 55, size: 20, promotesTo: 'esp2', relegatesTo: null, continentalSpots: 0, cupId: 'copa_rey' },
  ...
  { id: 'ger2', name: '2. Bundesliga', country: '독일', code: 'GER', tier: 2, conf: 'UEFA', strength: 72, size: 18, promotesTo: 'ger1', relegatesTo: 'ger3', continentalSpots: 0, cupId: 'dfb_pokal' },
  { id: 'ger3', name: '3. Liga', country: '독일', code: 'GER', tier: 3, conf: 'UEFA', strength: 55, size: 20, promotesTo: 'ger2', relegatesTo: null, continentalSpots: 0, cupId: 'dfb_pokal' },
  ...
  { id: 'ita2', name: 'Serie B', country: '이탈리아', code: 'ITA', tier: 2, conf: 'UEFA', strength: 70, size: 20, promotesTo: 'ita1', relegatesTo: 'ita3', continentalSpots: 0, cupId: 'coppa_italia' },
  { id: 'ita3', name: 'Serie C', country: '이탈리아', code: 'ITA', tier: 3, conf: 'UEFA', strength: 53, size: 20, promotesTo: 'ita2', relegatesTo: null, continentalSpots: 0, cupId: 'coppa_italia' },
  ...
  { id: 'fra2', name: 'Ligue 2', country: '프랑스', code: 'FRA', tier: 2, conf: 'UEFA', strength: 68, size: 18, promotesTo: 'fra1', relegatesTo: 'fra3', continentalSpots: 0, cupId: 'coupe_france' },
  { id: 'fra3', name: 'Championnat National', country: '프랑스', code: 'FRA', tier: 3, conf: 'UEFA', strength: 52, size: 18, promotesTo: 'fra2', relegatesTo: null, continentalSpots: 0, cupId: 'coupe_france' },
  ...
  { id: 'ned2', name: 'Eerste Divisie', country: '네덜란드', code: 'NED', tier: 2, conf: 'UEFA', strength: 60, size: 20, promotesTo: 'ned1', relegatesTo: 'ned3', continentalSpots: 0, cupId: 'knvb_beker' },
  { id: 'ned3', name: 'Tweede Divisie', country: '네덜란드', code: 'NED', tier: 3, conf: 'UEFA', strength: 48, size: 18, promotesTo: 'ned2', relegatesTo: null, continentalSpots: 0, cupId: 'knvb_beker' },
  ...
  { id: 'por2', name: 'Liga Portugal 2', country: '포르투갈', code: 'POR', tier: 2, conf: 'UEFA', strength: 62, size: 18, promotesTo: 'por1', relegatesTo: 'por3', continentalSpots: 0, cupId: 'taca_portugal' },
  { id: 'por3', name: 'Liga 3', country: '포르투갈', code: 'POR', tier: 3, conf: 'UEFA', strength: 50, size: 20, promotesTo: 'por2', relegatesTo: null, continentalSpots: 0, cupId: 'taca_portugal' },
  ...
  { id: 'bra2', name: 'Brasileirão Série B', country: '브라질', code: 'BRA', tier: 2, conf: 'CONMEBOL', strength: 70, size: 20, promotesTo: 'bra1', relegatesTo: 'bra3', continentalSpots: 0, cupId: 'copa_brasil' },
  { id: 'bra3', name: 'Brasileirão Série C', country: '브라질', code: 'BRA', tier: 3, conf: 'CONMEBOL', strength: 56, size: 20, promotesTo: 'bra2', relegatesTo: null, continentalSpots: 0, cupId: 'copa_brasil' },
  ...
  { id: 'arg2', name: 'Primera Nacional', country: '아르헨티나', code: 'ARG', tier: 2, conf: 'CONMEBOL', strength: 65, size: 18, promotesTo: 'arg1', relegatesTo: 'arg3', continentalSpots: 0, cupId: 'copa_argentina' },
  { id: 'arg3', name: 'Primera B Metropolitana', country: '아르헨티나', code: 'ARG', tier: 3, conf: 'CONMEBOL', strength: 53, size: 20, promotesTo: 'arg2', relegatesTo: null, continentalSpots: 0, cupId: 'copa_argentina' },
  ...
  { id: 'usa2', name: 'USL Championship', country: '미국', code: 'USA', tier: 2, conf: 'CONCACAF', strength: 60, size: 24, promotesTo: 'usa1', relegatesTo: 'usa3', continentalSpots: 0, cupId: 'us_open_cup' },
  { id: 'usa3', name: 'USL League One', country: '미국', code: 'USA', tier: 3, conf: 'CONCACAF', strength: 48, size: 12, promotesTo: 'usa2', relegatesTo: null, continentalSpots: 0, cupId: 'us_open_cup' },
  ...
  { id: 'kor2', name: 'K League 2', country: '대한민국', code: 'KOR', tier: 2, conf: 'AFC', strength: 62, size: 13, promotesTo: 'kor1', relegatesTo: 'kor3', continentalSpots: 0, cupId: 'fa_cup_kor' },
  { id: 'kor3', name: 'K3리그', country: '대한민국', code: 'KOR', tier: 3, conf: 'AFC', strength: 50, size: 16, promotesTo: 'kor2', relegatesTo: null, continentalSpots: 0, cupId: 'fa_cup_kor' },
  ...
  { id: 'jpn2', name: 'J2 League', country: '일본', code: 'JPN', tier: 2, conf: 'AFC', strength: 65, size: 22, promotesTo: 'jpn1', relegatesTo: 'jpn3', continentalSpots: 0, cupId: 'emperors_cup' },
  { id: 'jpn3', name: 'J3 League', country: '일본', code: 'JPN', tier: 3, conf: 'AFC', strength: 52, size: 20, promotesTo: 'jpn2', relegatesTo: null, continentalSpots: 0, cupId: 'emperors_cup' },
